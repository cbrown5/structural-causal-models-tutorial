...
The first five steps will lead us to a causal test of a particular relationship of interest, say do protected areas influence fish biomass? We then modify and repeat for different causes (step 6) or alternative hypotheses for the model (step 7). Here are the steps:
...
3.  **Test consistency of your conceptual model with your data (comprehensive only)**
...
1.  Create a conceptual model of your study system
2.  Choose a statistical test
3.  Identify confounding variables of you need to adjust for when testing the cause of interest
4.  Test for causality with your statistical test
5.  Repeat steps 3-5 above for other causes of interest
6.  Repeat steps 1-6 for other conceptual models
:::

We will cover SCM Classic in this course. Step 3 of "SCM Comprehensive" requires structural equation modelling techniques. SEM is already well covered [elsewhere](https://jslefche.github.io/sem_book/index.html) so I will only cover it briefly here.
...
![](images/scm-handdrawn.jpg)

**Image** A hand drawn DAG from our July 2023 workshop. Drawing your DAGs is a good way to start thinking about the variables and causes you want to represent
